package com.narendra.chucks.activity
...
import com.narendra.chucks.R
import com.narendra.chucks.util.ConnectionManager
import com.narendra.chucks.util.REGISTER
import com.narendra.chucks.util.SessionManager
import com.narendra.chucks.util.Validate
...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegister.setOnClickListener {
            ...
            if (Validate.validateNameLength(etName.text.toString())) {
                etName.error = null
                if (Validate.validateEmail(etEmail.text.toString())) {
                    etEmail.error = null
                    if (Validate.validateMobile(etPhoneNumber.text.toString())) {
                        etPhoneNumber.error = null
                        if (Validate.validatePasswordLength(etPassword.text.toString())) {
                            etPassword.error = null
                            if (Validate.matchPassword(
