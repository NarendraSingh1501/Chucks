package com.narendra.chucks.fragment
...
import com.narendra.chucks.adapter.AllRestaurantsAdapter
import com.narendra.chucks.model.Restaurants
import com.narendra.chucks.util.ConnectionManager
import com.narendra.chucks.util.DrawerLocker
import com.narendra.chucks.util.FETCH_RESTAURANTS
import com.narendra.chucks.util.Sort
...
class HomeFragment : Fragment() {
    ...
    private fun showDialog(context: Context) {
        ...
        builder?.setPositiveButton("Ok") { _, _ ->
            ...
            when (checkedItem) {
                0 -> {
                    Collections.sort(restaurantList, Sort.costComparator)
                }
                1 -> {
                    Collections.sort(restaurantList, Sort.costComparator)
                ...
                2 -> {
                    Collections.sort(restaurantList, Sort.ratingComparator)
                    restaurantList.reverse()
                }
            }
